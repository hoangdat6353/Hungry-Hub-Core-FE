...
export default function Schedule() {
  ...
  useEffect(() => {
    const selectedJSON = JSON.stringify(dateSchedule);

    localStorage.setItem('deliveryDateSchedule', selectedJSON);
  }, [dateSchedule]);

  useEffect(() => {
    const selectedJSON = JSON.stringify(timeSchedule);

    localStorage.setItem('deliveryTimeSchedule', selectedJSON);
  }, [timeSchedule]);
